...
const ResetPassword = ({ email = 'user@example.com', resetUrl = '' }) => {
  return (
    <Html>
      <Head />
      <Preview>Reset your OneStore password</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Section style={{ marginBottom: '32px' }}>
            ...
            <Text style={styles.paragraph}>
              We received a request to reset the password for your OneStore account associated with{' '}
              <strong style={{ color: 'oklch(0.9247 0.0524 66.1732)' }}>{email}</strong>.
